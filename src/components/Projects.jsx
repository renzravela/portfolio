...
import vuejobs from "./Project_Works/bgs/vuejobs.png";
        ...
        <Row>
          <Col>
            ...
            <Row className="project_list">
              ...
              />
              <Project
                title={`VueJobs Frontend`}
                description={`Single Page Application (Frontend as of now) built with vue, typescript and tailwind.`}
                bg={vuejobs}
                url={`https://findyourvuejobs.netlify.app/`}
              />
              <Project
